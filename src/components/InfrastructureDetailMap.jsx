...
export default function InfrastructureDetailMap({ infrastructure }) {
  // Vérifier si l'infrastructure a des coordonnées
  const hasCoordinates = infrastructure && infrastructure.latitude && infrastructure.longitude;
  const position = hasCoordinates ? [infrastructure.latitude, infrastructure.longitude] : DEFAULT_CENTER;
  ...
  return (
    <div className="h-[300px] w-full rounded-lg overflow-hidden border border-gray-300 shadow-md">
      <MapContainer 
        center={position} 
        zoom={15} 
